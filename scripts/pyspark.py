...
kinesisStreamName = "incoming-food-order-data-new"
kinesisRegion = "us-east-1"
checkpointLocation = "s3://stream-checkpointing-new/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.cib2qnw1u9sz.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://airline-data-ingestion-temp/flights_data/"
