...
jdbc_jar_s3_path = "s3://food-delivery-data-analyis-new/redshift-connection-jar/redshift-jdbc42-2.1.0.12.jar"
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://food-delivery-data-analyis-new/pyspark_script/pyspark.py',
